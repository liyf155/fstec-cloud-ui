<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <el-button v-if="sys_dict_add" class="filter-item" style="margin-left: 10px;" @click="toAdd" type="primary" icon="el-icon-plus">添加
      </el-button>
    </div>
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="正在加载..." border fit highlight-current-row style="width: 99%">
      ...
      <el-table-column label="操作" width="200">
        <template slot-scope="scope">
          <el-button v-if="sys_dict_upd" size="small" type="success" @click="toEdit(scope.row)">编辑
          </el-button>
          <el-button v-if="sys_dict_del" size="mini" type="danger" @click="DelDict(scope.row)">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-if="dialogStatus=='create'" type="primary" @click="AddDict('form')">确 定</el-button>
        <el-button v-else type="primary" @click="UpdDict('form')">修 改</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
<script>
import { getDictsByPage, addDict, updDict, delDict } from '@/api/admin/dict'
...
export default {
  ...
  methods: {
    getList() {
      ...
      getDictsByPage(this.listQuery).then(response => {
