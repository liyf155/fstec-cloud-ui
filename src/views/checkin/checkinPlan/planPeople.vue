  ...
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-form inline>
        ...
        <el-button
          ...
          icon="el-icon-plus"
        >添加</el-button>
        <el-button class="filter-item" type="info" icon="el-icon-back" @click="backToPlanPage">返回</el-button>
        <el-upload
          v-if="ck_checkinPeople_add"
          class="upload-demo"
    ...
    >
      ...
      <el-table-column fixed="right" align="center" label="操作" width="150">
        <template slot-scope="scope">
          <el-button
            v-if="ck_checkinPeople_edit"
            size="small"
            type="success"
            @click="handleUpdate(scope.row)"
          >编辑</el-button>
          <el-button
            v-if="ck_checkinPeople_del"
            size="small"
            type="danger"
            @click="deleteCheckinPeople(scope.row)"
          >删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :model="form" :rules="rules" ref="form" label-width="100px">
        <el-form-item label="省份名称" prop="provinceId">
          <el-select
            ...
            placeholder="==请选择=="
            @change="selectCityNameList(form)"
          >
            <el-option
              v-for="p in provinceNameList"
              :key="p.areaCode"
              :label="p.name"
              :value="p.areaCode"
            ></el-option>
        ...
        <el-form-item label="考点名称" prop="nodeId">
          <el-select v-model="form.nodeId" placeholder="==请选择==">
            <el-option v-for="n in nodeNameList" :key="n.id" :label="n.nodeName" :value="n.id"></el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="性别" prop="sex">
          <el-select v-model="form.sex" placeholder="==请选择==">
            <el-option v-for="s in sexList" :key="s.value" :label="s.label" :value="s.value"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="岗位名称" prop="postId">
          <el-select v-model="form.postId" placeholder="==请选择==">
            <el-option v-for="p in postNameList" :key="p.id" :label="p.postName" :value="p.id"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="科目名称" prop="subjectId">
          <el-select v-model="form.subjectId" placeholder="==请选择==">
            <el-option
              v-for="s in subjectNameList"
              :key="s.id"
              :label="s.subjectName"
              :value="s.id"
            ></el-option>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button
          ...
          type="primary"
          @click="createCheckinPeople('form')"
        >确 定</el-button>
