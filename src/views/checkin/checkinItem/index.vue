<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-form>
        ...
        <el-button v-if="ck_checkinItem_add" class="filter-item" style="margin-left: 10px;" @click="handleCreate" type="primary" icon="el-icon-plus">添加
        </el-button>
      </el-form>
    </div>
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" element-loading-text="正在加载..." border fit highlight-current-row style="width: 99%">
        ...
        <template slot-scope="scope">
          <el-button v-if="ck_checkinItem_edit" size="small" type="success" @click="handleUpdate(scope.row)">编辑
          </el-button>
          <el-button v-if="ck_checkinItem_del" size="small" type="danger" @click="deleteCheckinItem(scope.row)">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
  ...
  <el-input v-model="form.updateTime" placeholder="请输入更新时间"></el-input>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-if="dialogStatus=='create'" type="primary" @click="createCheckinItem('form')">确 定</el-button>
...
<script>
import {getCheckinItemsByPage, addCheckinItem, getCheckinItem, delCheckinItem, updCheckinItem} from '@/api/checkin/checkinItem';
