<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-form>
        ...
        <el-button v-if="mt_administrative_add" class="filter-item" style="margin-left: 10px;" @click="handleCreate" type="primary" icon="el-icon-plus">添加
        </el-button>
      </el-form>
    </div>
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" element-loading-text="正在加载..." border fit highlight-current-row style="width: 99%">
              <el-table-column align="center" label="AREA_CODE" width="65">
        <template slot-scope="scope">
          <span>{{scope.row.areaCode}}</span>
        </template>
      </el-table-column>
                      <el-table-column align="center" label="父级行政代码">
        <template slot-scope="scope">
        ...
        <template slot-scope="scope">
          <el-button v-if="mt_administrative_edit" size="small" type="success" @click="handleUpdate(scope.row)">编辑
          </el-button>
          <el-button v-if="mt_administrative_del" size="small" type="danger" @click="deleteAdministrative(scope.row)">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
  ...
  <el-input v-model="form.lat" placeholder="请输入纬度"></el-input>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-if="dialogStatus=='create'" type="primary" @click="createAdministrative('form')">确 定</el-button>
...
<script>
import {getAdministrativesByPage, addAdministrative, getAdministrative, delAdministrative, updAdministrative} from '@/api/checkin/administrative';
