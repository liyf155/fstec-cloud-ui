<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input style="width:300px" class="filter-item" placeholder="模糊查询" v-model="listQuery.nodeName" @keyup.enter.native="handleFilter"></el-input>
      <el-button class="filter-item" type="primary" v-waves icon="el-icon-search" @click="handleFilter">搜索</el-button>
      <el-button v-if="pf_examNode_add" class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-plus" @click="handleCreate">添加</el-button>
      <el-upload class="upload-demo" action="/platform/examNode/upload" :headers="headers" :onError="uploadError" :onSuccess="uploadSuccess" :beforeUpload="beforeUpload">
    ...
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" element-loading-text="正在加载..." border fit highlight-current-row style="width: 99%">
      ...
      <el-table-column fixed="right" align="center" label="操作" width="150"> 
        <template slot-scope="scope">
          <el-button v-if="pf_examNode_edit" size="small" type="success" @click="handleUpdate(scope.row)">编辑
          </el-button>
          <el-button v-if="pf_examNode_del" size="small" type="danger" @click="deleteExamNode(scope.row)">删除
          </el-button>
        </template> 
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :model="form" :rules="rules" ref="form" label-width="100px">
        <el-form-item label="所属城市名称" prop="cityName">
          <el-input v-model="form.administrativeName" placeholder="请输入所属城市名称"></el-input>
        </el-form-item>
        ...
        <el-form-item label="考点地址" prop="address">
          <el-input v-model="form.nodeAddress" placeholder="请输入考点地址"></el-input>
        </el-form-item>
...
<script>
import { getExamNodesByPage, addExamNode, getExamNode, delExamNode, updExamNode } from '@/api/platform/examNode'
...
export default {
  ...
  data() {
    return {
      ...
      dialogStatus: '',
      pf_examNode_add: false,
      pf_examNode_del: false,
      pf_examNode_edit: false,
      textMap: {
        update: '编辑',
        create: '创建'
      },
  ...
  created() {
    this.getList()
    this.pf_examNode_add = this.permissions['pf_examNode_add']
    this.pf_examNode_edit = this.permissions['pf_examNode_edit']
    this.pf_examNode_del = this.permissions['pf_examNode_del']
  },
  computed: {
    ...mapGetters([
      'permissions'
